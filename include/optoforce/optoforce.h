...
{
public:
  optoforceROS(ros::NodeHandle &nh)
  {
    optoforce_pub_ = nh.advertise<optoforce::FTsensor>("/optoforce/ftsensor",3);
  }
  virtual ~optoforceROS(){}
  ...
  {
    ft_msg_.Fx = r.fx / FORCE_DIV;
    ft_msg_.Fy = r.fy / FORCE_DIV;
    ft_msg_.Fz = r.fz / FORCE_DIV;
    ft_msg_.Tx = r.tx / TORQUE_DIV;
    ft_msg_.Ty = r.ty / TORQUE_DIV;
    ft_msg_.Tz = r.tz / TORQUE_DIV;
